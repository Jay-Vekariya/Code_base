...
const AboutUs = () => {
  return (
    <div className="flex flex-row bg-green-300 font-serif min-w-[500px]">
      <div className="text-center md:text-wrap sm:text-wrap md:items-center sm:items-center">
        <p className="font-bold text-[30px] flex flex-col mt-[20px] items-center h-[40px]">
          Why Us?
        </p>
        <p className="p-10 text-[25px]">
